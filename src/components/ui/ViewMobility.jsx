      ...
      <nav className='mb-8'>
        <div className='border-b-2 flex flex-wrap justify-between items-center text-sm font-extrabold'>
          <ul className='flex flex-wrap gap-6'>
            {['LATEST NEWS', 'FEATURES', 'MANUFACTURING', 'MOBILITY'].map(
              (item, i) => (
          ...
          >
            <div className='relative'>
              ...
              <div className='absolute inset-0 flex flex-col items-end justify-start gap-4 opacity-0 group-hover:opacity-100 transition duration-500 p-4'>
                <button className='text-gray-200 text-xs hover:text-white'>
                  Add to Cart 🛒
                </button>
                <button className='text-gray-200 text-xs hover:text-white'>
                  Convert to PDF
            ...
            <div className='p-4'>
              <h2 className='text-red-500 text-sm font-extrabold mb-2'>
                {item.category}
              </h2>
